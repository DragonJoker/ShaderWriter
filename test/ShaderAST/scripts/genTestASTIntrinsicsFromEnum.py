...
def printHeader( outs, match ):
	...
	outs.write( '\t}\n' )
	outs.write( '\n' )
	outs.write( '\tstatic std::string getName( type::MemorySemantics p )\n' )
	outs.write( '\t{\n' )
	...
	outs.write( '\t}\n' )
	outs.write( '\n' )
	outs.write( '\tstatic std::string getBarrierParamName( BarrierParam p )\n' )
	outs.write( '\t{\n' )
	...
	outs.write( '\t}\n' )
	outs.write( '\n' )
	outs.write( '\tstatic std::vector< BarrierParam > const barrierParams{ []()\n' )
	outs.write( '\t\t{\n' )
