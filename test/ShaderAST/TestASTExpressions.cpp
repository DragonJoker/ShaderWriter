...
namespace
{
	...
	void testExprIdentifier( test::TestCounts & testCounts )
	{
		...
		testCounts << "ExprIdentifier: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprAdd( test::TestCounts & testCounts )
	{
		...
		testCounts << "ExprAdd: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprMinus( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprMinus: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprTimes( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprTimes: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprDivide( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprDivide: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprBitAnd( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprBitAnd: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprBitNot( test::TestCounts & testCounts )
	{
		...
		testCounts << "ExprBitNot: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprBitOr( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprBitOr: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprBitXor( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprBitXor: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprLogAnd( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprLogAnd: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprLogNot( test::TestCounts & testCounts )
	{
		...
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getName() == "op" );
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getType()->getKind() == ast::type::Kind::eInt32 );
		testCounts << "ExprLogNot: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprLogOr( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprLogOr: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprModulo( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprModulo: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprLShift( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprLShift: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprRShift( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprRShift: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprComma( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprComma: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprArrayAccess( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprArrayAccess: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprAssign( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprAssign: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprAddAssign( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprAddAssign: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprDivideAssign( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprDivideAssign: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprMinusAssign( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprMinusAssign: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprTimesAssign( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprTimesAssign: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprModuloAssign( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprModuloAssign: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprLShiftAssign( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprLShiftAssign: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprRShiftAssign( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprRShiftAssign: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprAndAssign( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprAndAssign: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprOrAssign( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprOrAssign: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprXorAssign( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprXorAssign: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprEqual( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprEqual: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprGreater( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprGreater: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprGreaterEqual( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprGreaterEqual: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprLess( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprLess: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprLessEqual( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprLessEqual: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprNotEqual( test::TestCounts & testCounts )
	{
		...
		require( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getLiteralType() == ast::expr::LiteralType::eInt32 );
		check( static_cast< ast::expr::Literal const & >( *expr->getRHS() ).getValue< ast::expr::LiteralType::eInt32 >() == 10 );
		testCounts << "ExprNotEqual: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprPostDecrement( test::TestCounts & testCounts )
	{
		...
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getName() == "op" );
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getType()->getKind() == ast::type::Kind::eInt32 );
		testCounts << "ExprPostDecrement: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprPostIncrement( test::TestCounts & testCounts )
	{
		...
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getName() == "op" );
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getType()->getKind() == ast::type::Kind::eInt32 );
		testCounts << "ExprPostIncrement: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprPreDecrement( test::TestCounts & testCounts )
	{
		...
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getName() == "op" );
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getType()->getKind() == ast::type::Kind::eInt32 );
		testCounts << "ExprPreDecrement: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprPreIncrement( test::TestCounts & testCounts )
	{
		...
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getName() == "op" );
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getType()->getKind() == ast::type::Kind::eInt32 );
		testCounts << "ExprPreIncrement: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprUnaryMinus( test::TestCounts & testCounts )
	{
		...
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getName() == "op" );
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getType()->getKind() == ast::type::Kind::eInt32 );
		testCounts << "ExprUnaryMinus: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprUnaryPlus( test::TestCounts & testCounts )
	{
		...
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getName() == "op" );
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getType()->getKind() == ast::type::Kind::eInt32 );
		testCounts << "ExprUnaryPlus: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprCast( test::TestCounts & testCounts )
	{
		...
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getName() == "op" );
		check( static_cast< ast::expr::Identifier const & >( *expr->getOperand() ).getVariable()->getType()->getKind() == ast::type::Kind::eInt32 );
		testCounts << "ExprCast: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprCompositeConstruct( test::TestCounts & testCounts )
	{
		...
		testCounts << "ExprCompositeConstruct: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprIntrinsicCall( test::TestCounts & testCounts )
	{
		testBegin( "testExprIntrinsicCall" );
		{
			...
			testCounts << "ExprIntrinsicCall: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		}
		testEnd();
	}
	...
	void testExprImageAccessCall( test::TestCounts & testCounts )
	{
		testBegin( "testExprImageAccessCall" );
		{
			...
			testCounts << "ExprImageAccessCall: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		}
		testEnd();
	}
	...
	void testExprCombinedImageAccessCall( test::TestCounts & testCounts )
	{
		testBegin( "testExprCombinedImageAccessCall" );
		{
			...
			testCounts << "ExprCombinedImageAccessCall: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		}
		testEnd();
	}
	...
	void testExprAggrInit( test::TestCounts & testCounts )
	{
		...
		}
		{
			...
			testCounts << "ExprAggrInit: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		}
		testEnd();
	}
	...
	void testExprInit( test::TestCounts & testCounts )
	{
		...
		testCounts << "ExprInit: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprMbrSelect( test::TestCounts & testCounts )
	{
		...
		testCounts << "ExprMbrSelect: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprQuestion( test::TestCounts & testCounts )
	{
		...
		testCounts << "ExprQuestion: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprSwitchCase( test::TestCounts & testCounts )
	{
		...
		testCounts << "ExprSwitchCase: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
	...
	void testExprSwitchTest( test::TestCounts & testCounts )
	{
		...
		testCounts << "ExprSwitchTest: " << ast::debug::ExprVisitor::submit( expr ) << test::endl;
		testEnd();
	}
