...
namespace
{
	...
	TEST_F( Compute, construction )
	{
		...
		{
			sdw::ComputeWriter writer{ 0u, &testCounts.allocator };
		}
		{
			sdw::ComputeWriter writer{ ast::stmt::FunctionFlag::eNone, &testCounts.allocator };
		}
		{
			sdw::ComputeWriter writer{ ast::stmt::FunctionFlag::eMaximalReconvergence, &testCounts.allocator };
		}
		{
			ast::ShaderBuilder builder{ ast::ShaderStage::eCompute, &testCounts.allocator };
			sdw::ComputeWriter writer{ builder };
		}
		{
			ast::ShaderBuilder builder{ ast::ShaderStage::eCompute, &testCounts.allocator };
			sdw::ComputeWriter writer{ builder, 0u };
		}
		{
			ast::ShaderBuilder builder{ ast::ShaderStage::eCompute, &testCounts.allocator };
			sdw::ComputeWriter writer{ builder, ast::stmt::FunctionFlag::eNone };
		}
		{
			ast::ShaderBuilder builder{ ast::ShaderStage::eCompute, &testCounts.allocator };
			sdw::ComputeWriter writer{ builder, ast::stmt::FunctionFlag::eMaximalReconvergence };
		}
		sdwTestEnd()
	}

	TEST_F( Compute, emptyMain )
	{
	...
	TEST_F( Compute, readWorkGroupSize )
	{
	...
	TEST_F( Compute, computeTypeless )
	{
	...
	TEST_F( Compute, accessChainAlias )
	{
	...
	TEST_F( Compute, duplicateLoadTest )
	{
	...
	TEST_F( Compute, subgroupEmptyMain )
	{
	...
	TEST_F( Compute, subgroupBuiltins )
	{
	...
	TEST_F( Compute, subgroupCompute )
	{
	...
	TEST_F( Compute, subgroupSimpleStore )
	{
	...
	TEST_F( Compute, bufferReferenceBase )
	{
	...
	TEST_F( Compute, bufferReference )
	{
