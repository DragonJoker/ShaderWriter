...
namespace
{
	...
	void fragment( test::sdw_test::TestCounts & testCounts )
	{
		...
		auto c3d_mapDiffuse = writer.declCombined< FImg2DRgba32 >( "c3d_mapDiffuse", 1u, 0u );
	...
	void radianceComputer( test::sdw_test::TestCounts & testCounts )
	{
		...
		// Inputs
		auto c3d_mapEnvironment = writer.declCombined< FImgCubeRgba32 >( "c3d_mapEnvironment", 1u, 0u );
	...
	void textureOffset( test::sdw_test::TestCounts & testCounts )
	{
		...
		using namespace sdw;
		{
			...
			auto s = writer.declCombined< FImg2DRgba32 >( "s", 0u, 0u );
	...
	void skybox( test::sdw_test::TestCounts & testCounts )
	{
		...
		auto c3d_mapSkybox = writer.declCombined< FImg2DRgba32 >( "c3d_mapSkybox", 1u, 0u );
