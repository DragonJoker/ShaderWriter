...
*/
#ifndef ___AST_HlslSampledImageAccessNames_H___
#define ___AST_HlslSampledImageAccessNames_H___
#pragma once
...
namespace hlsl
{
	inline std::string getHlslName( ast::expr::SampledImageAccess value )
	{
		std::string result;
