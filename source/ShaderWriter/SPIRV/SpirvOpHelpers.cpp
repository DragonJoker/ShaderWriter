...
*/
#include "ShaderWriter/SPIRV/SpirvOpHelpers.hpp"
...
namespace sdw::spirv
{
	...
	namespace
	{
		bool isFloating( type::Kind kind )
		{
			return kind == type::Kind::eFloat
				|| kind == type::Kind::eDouble
				|| kind == type::Kind::eVec2F
				|| kind == type::Kind::eVec3F
				|| kind == type::Kind::eVec4F
				|| kind == type::Kind::eVec2D
				|| kind == type::Kind::eVec3D
				|| kind == type::Kind::eVec4D
				|| kind == type::Kind::eMat2x2F
				|| kind == type::Kind::eMat2x3F
				|| kind == type::Kind::eMat2x4F
				|| kind == type::Kind::eMat2x2D
				|| kind == type::Kind::eMat2x3D
				|| kind == type::Kind::eMat2x4D
				|| kind == type::Kind::eMat3x2F
				|| kind == type::Kind::eMat3x3F
				|| kind == type::Kind::eMat3x4F
				|| kind == type::Kind::eMat3x2D
				|| kind == type::Kind::eMat3x3D
				|| kind == type::Kind::eMat3x4D
				|| kind == type::Kind::eMat4x2F
				|| kind == type::Kind::eMat4x3F
				|| kind == type::Kind::eMat4x4F
				|| kind == type::Kind::eMat4x2D
				|| kind == type::Kind::eMat4x3D
				|| kind == type::Kind::eMat4x4D;
		}

		bool isSigned( type::Kind kind )
		{
			return kind == type::Kind::eInt
				|| kind == type::Kind::eVec2I
				|| kind == type::Kind::eVec3I
				|| kind == type::Kind::eVec4I;
		}
	}
	...
	bool isAnySigned( type::Kind typeKind )
	{
		return isSigned( typeKind );
	}

	bool isAnySigned( type::Kind lhsTypeKind
	...
	bool isAnyFloating( type::Kind typeKind )
	{
		return isFloating( typeKind );
	}

	bool isAnyFloating( type::Kind lhsTypeKind
		, type::Kind rhsTypeKind )
	{
