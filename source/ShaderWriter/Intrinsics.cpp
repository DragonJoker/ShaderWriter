...
namespace sdw
{
	Vec4 operator*( Vec4 const & lhs, Mat4 const & rhs )
	{
		...
		result.m_value << std::string( lhs ) << cuT( " * " ) << std::string( rhs );
		return result;
	}
	...
	Float operator+( float lhs, Float const & rhs )
	{
		...
		result.m_value << toString( lhs ) << cuT( " + " ) << std::string( rhs );
		return result;
	}
	...
	{
		Int result( findWriter( lhs, rhs ) );
		result.m_value << std::string( lhs ) << cuT( " % " ) << toString( rhs );
		return result;
	}
	...
	{
		return writeFunctionCall< Int >( value.m_container, cuT( "bitfieldReverse" ), value );
	}

	UInt bitfieldReverse( UInt const & value )
	{
		return writeFunctionCall< UInt >( value.m_container, cuT( "bitfieldReverse" ), value );
	}

	Int findMSB( Int value )
	{
		return writeFunctionCall< Int >( value.m_container, cuT( "findMSB" ), value );
	}
	...
	{
		return writeFunctionCall< Float >( value.m_container, cuT( "length" ), value );
	}
	...
	{
		return writeFunctionCall< Float >( value.m_container, cuT( "radians" ), value );
	}

	Float cos( Type const & value )
	{
		return writeFunctionCall< Float >( value.m_container, cuT( "cos" ), value );
	}

	Float sin( Type const & value )
	{
		return writeFunctionCall< Float >( value.m_container, cuT( "sin" ), value );
	}

	Float tan( Type const & value )
	{
		return writeFunctionCall< Float >( value.m_container, cuT( "tan" ), value );
	}
