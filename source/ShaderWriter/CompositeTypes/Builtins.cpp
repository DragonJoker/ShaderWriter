...
namespace sdw
{
	...
	InVertex::InVertex( ShaderWriter & writer )
		: gl_VertexID{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_VertexID", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
		, gl_InstanceID{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_InstanceID", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
		, gl_DrawID{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_DrawID", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
		, gl_BaseVertex{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_BaseVertex", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
		, gl_BaseInstance{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_BaseInstance", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
	{
	}
	...
	InTessellationControl::InTessellationControl( ShaderWriter & writer )
		: gl_PatchVerticesIn{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_PatchVerticesIn", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
		, gl_PrimitiveID{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_PrimitiveID", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
		, gl_InvocationID{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_InvocationID", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
	...
	InGeometry::InGeometry( ShaderWriter & writer )
		: gl_PrimitiveIDIn{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_PrimitiveIDIn", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
		, gl_InvocationID{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_InvocationID", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
		, gl_in{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_in", nullptr, var::Flag::eShaderInput ) ) }// TODO
	...
	InFragment::InFragment( ShaderWriter & writer )
		...
		, gl_SampleID{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_SampleID", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
		...
		, gl_SampleMaskIn{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_SampleMaskIn", writer.getTypesCache().getArray( writer.getTypesCache().getUInt(), type::UnknownArraySize ), var::Flag::eShaderInput ) ) }
		...
		, gl_Layer{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_Layer", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
		, gl_ViewportIndex{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_ViewportIndex", writer.getTypesCache().getUInt(), var::Flag::eShaderInput ) ) }
	{
	}
	...
	OutGeometry::OutGeometry( ShaderWriter & writer )
		: gl_PrimitiveID{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_PrimitiveID", writer.getTypesCache().getUInt(), var::Flag::eShaderOutput ) ) }
		, gl_Layer{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_Layer", writer.getTypesCache().getUInt(), var::Flag::eShaderOutput ) ) }
		, gl_ViewportIndex{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_ViewportIndex", writer.getTypesCache().getUInt(), var::Flag::eShaderOutput ) ) }
	...
	OutFragment::OutFragment( ShaderWriter & writer )
		...
		, gl_SampleMask{ &writer.getShader(), makeIdent( writer.getTypesCache()
			, writer.getShader().registerBuiltin( "gl_SampleMask", writer.getTypesCache().getArray( writer.getTypesCache().getUInt(), type::UnknownArraySize ), var::Flag::eShaderOutput ) ) }
	{
	}
