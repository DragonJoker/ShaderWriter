...
*/
#ifndef ___AST_GlslSampledImageAccessNames_H___
#define ___AST_GlslSampledImageAccessNames_H___
#pragma once
...
namespace glsl
{
	inline std::string getGlslName( ast::expr::SampledImageAccess value )
	{
		std::string result;
