...
*/
#ifndef ___SDW_SpirvSampledImageAccessConfig_H___
#define ___SDW_SpirvSampledImageAccessConfig_H___
#pragma once
...
namespace spirv
{
	inline spv::ImageOperandsMask getLod( ast::expr::SampledImageAccess value )
	{
	...
	inline spv::ImageOperandsMask getGrad( ast::expr::SampledImageAccess value )
	{
		spv::ImageOperandsMask result{};
	...
	inline spv::ImageOperandsMask getOffset( ast::expr::SampledImageAccess value
		, bool constOffset )
	{
		spv::ImageOperandsMask result{};
	...
	inline spv::ImageOperandsMask getConstOffsets( ast::expr::SampledImageAccess value )
	{
		spv::ImageOperandsMask result{};
	...
	inline spv::ImageOperandsMask getBias( ast::expr::SampledImageAccess value )
	{
		spv::ImageOperandsMask result{};
	...
	inline spv::ImageOperandsMask getMask( ast::expr::SampledImageAccess value
		, bool constOffset )
	{
	...
	inline void getSpirVConfig( ast::expr::SampledImageAccess value
