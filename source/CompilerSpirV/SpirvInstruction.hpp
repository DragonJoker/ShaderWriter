...
#pragma GCC diagnostic pop
	...
	using GroupNonUniformElectInstruction = InstructionT< spv::OpGroupNonUniformElect, true, true, 4u, false, false >;
	using GroupNonUniformAllInstruction = InstructionT< spv::OpGroupNonUniformAll, true, true, 5u, false, false >;
	using GroupNonUniformAnyInstruction = InstructionT< spv::OpGroupNonUniformAny, true, true, 5u, false, false >;
	using GroupNonUniformAllEqualInstruction = InstructionT< spv::OpGroupNonUniformAllEqual, true, true, 5u, false, false >;
	using GroupNonUniformBroadcastInstruction = InstructionT< spv::OpGroupNonUniformBroadcast, true, true, 6u, false, false >;
	using GroupNonUniformBroadcastFirstInstruction = InstructionT< spv::OpGroupNonUniformBroadcastFirst, true, true, 5u, false, false >;
	using GroupNonUniformBallotInstruction = InstructionT< spv::OpGroupNonUniformBallot, true, true, 5u, false, false >;
	using GroupNonUniformInverseBallotInstruction = InstructionT< spv::OpGroupNonUniformInverseBallot, true, true, 5u, false, false >;
	using GroupNonUniformBallotBitExtractInstruction = InstructionT< spv::OpGroupNonUniformBallotBitExtract, true, true, 5u, false, false >;
	using GroupNonUniformBallotBitCountInstruction = InstructionT< spv::OpGroupNonUniformBallotBitCount, true, true, 6u, false, false >;
	using GroupNonUniformBallotFindLSBInstruction = InstructionT< spv::OpGroupNonUniformBallotFindLSB, true, true, 5u, false, false >;
	using GroupNonUniformBallotFindMSBInstruction = InstructionT< spv::OpGroupNonUniformBallotFindMSB, true, true, 5u, false, false >;
	using GroupNonUniformShuffleInstruction = InstructionT< spv::OpGroupNonUniformShuffle, true, true, 6u, false, false >;
	using GroupNonUniformShuffleXorInstruction = InstructionT< spv::OpGroupNonUniformShuffleXor, true, true, 6u, false, false >;
	using GroupNonUniformShuffleUpInstruction = InstructionT< spv::OpGroupNonUniformShuffleUp, true, true, 6u, false, false >;
	using GroupNonUniformShuffleDownInstruction = InstructionT< spv::OpGroupNonUniformShuffleDown, true, true, 6u, false, false >;
	using GroupNonUniformQuadBroadcastInstruction = InstructionT< spv::OpGroupNonUniformQuadBroadcast, true, true, 6u, false, false >;
	using GroupNonUniformQuadSwapInstruction = InstructionT< spv::OpGroupNonUniformQuadSwap, true, true, 6u, false, false >;
