...
namespace sdw
{
	...
	template< StringLiteralT FieldNameT, uint32_t LocationT > using IOIntField = IOStructFieldT< Int, FieldNameT, LocationT >;
	template< StringLiteralT FieldNameT, uint32_t LocationT > using IOUIntField = IOStructFieldT< UInt, FieldNameT, LocationT >;
	...
	template< StringLiteralT FieldNameT, uint32_t LocationT > using IOIVec2Field = IOStructFieldT< IVec2, FieldNameT, LocationT >;
	template< StringLiteralT FieldNameT, uint32_t LocationT > using IOIVec3Field = IOStructFieldT< IVec3, FieldNameT, LocationT >;
	template< StringLiteralT FieldNameT, uint32_t LocationT > using IOIVec4Field = IOStructFieldT< IVec4, FieldNameT, LocationT >;
	template< StringLiteralT FieldNameT, uint32_t LocationT > using IOUVec2Field = IOStructFieldT< UVec2, FieldNameT, LocationT >;
	template< StringLiteralT FieldNameT, uint32_t LocationT > using IOUVec3Field = IOStructFieldT< UVec3, FieldNameT, LocationT >;
	template< StringLiteralT FieldNameT, uint32_t LocationT > using IOUVec4Field = IOStructFieldT< UVec4, FieldNameT, LocationT >;
