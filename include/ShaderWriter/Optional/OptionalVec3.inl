...
namespace sdw
{
		...
		, Vec3T< ValueT > const & rhs )
	{
		return Vec3T< ValueT >{ findShader( lhs, rhs )
			, sdw::makeAdd( Vec3T< ValueT >::makeType( findTypesCache( lhs, rhs ) )
				, makeExpr( lhs )
				, makeExpr( rhs ) ) };
	}
	...
	{
		return Vec3T< ValueT >{ findShader( lhs, rhs )
			, sdw::makeMinus( Vec3T< ValueT >::makeType( findTypesCache( lhs, rhs ) )
				, makeExpr( lhs )
				, makeExpr( rhs ) ) };
	}
	...
	{
		return Vec3T< ValueT >{ findShader( lhs, rhs )
			, sdw::makeDivide( Vec3T< ValueT >::makeType( findTypesCache( lhs, rhs ) )
				, makeExpr( lhs )
				, makeExpr( rhs ) ) };
	}
