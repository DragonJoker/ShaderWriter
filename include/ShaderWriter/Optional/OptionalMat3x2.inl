...
namespace sdw
{
	...
	template< typename ValueT >
	Optional< Mat3x2T< ValueT > >::Optional( Mat3x2T< ValueT > const & rhs
		, bool enabled )
		: Mat3x2T< ValueT >{ rhs }
		, m_enabled{ enabled }
	{
	...
	template< typename ValueT >
	inline Optional< Mat3x2T< ValueT > > & Optional< Mat3x2T< ValueT > >::operator=( Mat3x2T< ValueT > const & rhs )
	{
		if ( isEnabled() )
		{
	...
	template< typename ValueT >
	inline Optional< Mat3x2T< ValueT > > & Optional< Mat3x2T< ValueT > >::operator=( Optional< Mat3x2T< ValueT > > const & rhs )
	{
	...
	Optional< Vec2T< ValueT > > Optional< Mat3x2T< ValueT > >::operator[]( IndexT const & offset )const
	{
