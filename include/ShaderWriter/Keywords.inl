...
namespace sdw
{
	inline std::string const & KeywordsBase::getVersion()const
	{
		return m_version;
	}

	inline std::string const & KeywordsBase::getIn()const
	{
		REQUIRE( !m_in.empty() );
		return m_in;
	}

	inline std::string const & KeywordsBase::getOut()const
	{
		REQUIRE( !m_out.empty() );
		return m_out;
	}

	inline std::string const & KeywordsBase::getTexture1D()const
	{
		REQUIRE( !m_texture1D.empty() );
		return m_texture1D;
	}

	inline std::string const & KeywordsBase::getTexture1DLod()const
	{
		REQUIRE( !m_texture1DLod.empty() );
		return m_texture1DLod;
	}

	inline std::string const & KeywordsBase::getTexture1DOffset()const
	{
		REQUIRE( !m_texture1DOffset.empty() );
		return m_texture1DOffset;
	}

	inline std::string const & KeywordsBase::getTexture1DOffsetLod()const
	{
		REQUIRE( !m_texture1DOffsetLod.empty() );
		return m_texture1DOffsetLod;
	}

	inline std::string const & KeywordsBase::getTexture1DLodOffset()const
	{
		REQUIRE( !m_texture1DLodOffset.empty() );
		return m_texture1DLodOffset;
	}

	inline std::string const & KeywordsBase::getTexture2D()const
	{
		REQUIRE( !m_texture2D.empty() );
		return m_texture2D;
	}

	inline std::string const & KeywordsBase::getTexture2DLod()const
	{
		REQUIRE( !m_texture2DLod.empty() );
		return m_texture2DLod;
	}

	inline std::string const & KeywordsBase::getTexture2DOffset()const
	{
		REQUIRE( !m_texture2DOffset.empty() );
		return m_texture2DOffset;
	}

	inline std::string const & KeywordsBase::getTexture2DOffsetLod()const
	{
		REQUIRE( !m_texture2DOffsetLod.empty() );
		return m_texture2DOffsetLod;
	}

	inline std::string const & KeywordsBase::getTexture2DLodOffset()const
	{
		REQUIRE( !m_texture2DLodOffset.empty() );
		return m_texture2DLodOffset;
	}

	inline std::string const & KeywordsBase::getTexture3D()const
	{
		REQUIRE( !m_texture3D.empty() );
		return m_texture3D;
	}

	inline std::string const & KeywordsBase::getTexture3DLod()const
	{
		REQUIRE( !m_texture3DLod.empty() );
		return m_texture3DLod;
	}

	inline std::string const & KeywordsBase::getTexture3DOffset()const
	{
		REQUIRE( !m_texture3DOffset.empty() );
		return m_texture3DOffset;
	}

	inline std::string const & KeywordsBase::getTexture3DOffsetLod()const
	{
		REQUIRE( !m_texture3DOffsetLod.empty() );
		return m_texture3DOffsetLod;
	}

	inline std::string const & KeywordsBase::getTexture3DLodOffset()const
	{
		REQUIRE( !m_texture3DLodOffset.empty() );
		return m_texture3DLodOffset;
	}

	inline std::string const & KeywordsBase::getTextureCube()const
	{
		REQUIRE( !m_textureCube.empty() );
		return m_textureCube;
	}

	inline std::string const & KeywordsBase::getTextureCubeLod()const
	{
		REQUIRE( !m_textureCubeLod.empty() );
		return m_textureCubeLod;
	}

	inline std::string const & KeywordsBase::getTexture1DArray()const
	{
		REQUIRE( !m_texture1DArray.empty() );
		return m_texture1DArray;
	}

	inline std::string const & KeywordsBase::getTexture1DArrayLod()const
	{
		REQUIRE( !m_texture1DArrayLod.empty() );
		return m_texture1DArrayLod;
	}

	inline std::string const & KeywordsBase::getTexture1DArrayOffset()const
	{
		REQUIRE( !m_texture1DArrayOffset.empty() );
		return m_texture1DArrayOffset;
	}

	inline std::string const & KeywordsBase::getTexture1DArrayOffsetLod()const
	{
		REQUIRE( !m_texture1DArrayOffsetLod.empty() );
		return m_texture1DArrayOffsetLod;
	}

	inline std::string const & KeywordsBase::getTexture1DArrayLodOffset()const
	{
		REQUIRE( !m_texture1DArrayLodOffset.empty() );
		return m_texture1DArrayLodOffset;
	}

	inline std::string const & KeywordsBase::getTexture2DArray()const
	{
		REQUIRE( !m_texture2DArray.empty() );
		return m_texture2DArray;
	}

	inline std::string const & KeywordsBase::getTexture2DArrayLod()const
	{
		REQUIRE( !m_texture2DArrayLod.empty() );
		return m_texture2DArrayLod;
	}

	inline std::string const & KeywordsBase::getTexture2DArrayOffset()const
	{
		REQUIRE( !m_texture2DArrayOffset.empty() );
		return m_texture2DArrayOffset;
	}

	inline std::string const & KeywordsBase::getTexture2DArrayOffsetLod()const
	{
		REQUIRE( !m_texture2DArrayOffsetLod.empty() );
		return m_texture2DArrayOffsetLod;
	}

	inline std::string const & KeywordsBase::getTexture2DArrayLodOffset()const
	{
		REQUIRE( !m_texture2DArrayLodOffset.empty() );
		return m_texture2DArrayLodOffset;
	}

	inline std::string const & KeywordsBase::getTextureCubeArray()const
	{
		REQUIRE( !m_textureCubeArray.empty() );
		return m_textureCubeArray;
	}

	inline std::string const & KeywordsBase::getTextureCubeArrayLod()const
	{
		REQUIRE( !m_textureCubeShadowLod.empty() );
		return m_textureCubeShadowLod;
	}

	inline std::string const & KeywordsBase::getTexture1DShadow()const
	{
		REQUIRE( !m_texture1DShadow.empty() );
		return m_texture1DShadow;
	}

	inline std::string const & KeywordsBase::getTexture1DShadowLod()const
	{
		REQUIRE( !m_texture1DShadowLod.empty() );
		return m_texture1DShadowLod;
	}

	inline std::string const & KeywordsBase::getTexture1DShadowOffset()const
	{
		REQUIRE( !m_texture1DShadowOffset.empty() );
		return m_texture1DShadowOffset;
	}

	inline std::string const & KeywordsBase::getTexture1DShadowOffsetLod()const
	{
		REQUIRE( !m_texture1DShadowOffsetLod.empty() );
		return m_texture1DShadowOffsetLod;
	}

	inline std::string const & KeywordsBase::getTexture1DShadowLodOffset()const
	{
		REQUIRE( !m_texture1DShadowLodOffset.empty() );
		return m_texture1DShadowLodOffset;
	}

	inline std::string const & KeywordsBase::getTexture2DShadow()const
	{
		REQUIRE( !m_texture2DShadow.empty() );
		return m_texture2DShadow;
	}

	inline std::string const & KeywordsBase::getTexture2DShadowLod()const
	{
		REQUIRE( !m_texture2DShadowLod.empty() );
		return m_texture2DShadowLod;
	}

	inline std::string const & KeywordsBase::getTexture2DShadowOffset()const
	{
		REQUIRE( !m_texture2DShadowOffset.empty() );
		return m_texture2DShadowOffset;
	}

	inline std::string const & KeywordsBase::getTexture2DShadowOffsetLod()const
	{
		REQUIRE( !m_texture2DShadowOffsetLod.empty() );
		return m_texture2DShadowOffsetLod;
	}

	inline std::string const & KeywordsBase::getTexture2DShadowLodOffset()const
	{
		REQUIRE( !m_texture2DShadowLodOffset.empty() );
		return m_texture2DShadowLodOffset;
	}

	inline std::string const & KeywordsBase::getTextureCubeShadow()const
	{
		REQUIRE( !m_textureCubeShadow.empty() );
		return m_textureCubeShadow;
	}

	inline std::string const & KeywordsBase::getTextureCubeShadowLod()const
	{
		REQUIRE( !m_textureCubeShadowLod.empty() );
		return m_textureCubeShadowLod;
	}

	inline std::string const & KeywordsBase::getTexture1DArrayShadow()const
	{
		REQUIRE( !m_texture1DArrayShadow.empty() );
		return m_texture1DArrayShadow;
	}

	inline std::string const & KeywordsBase::getTexture1DArrayShadowLod()const
	{
		REQUIRE( !m_texture1DArrayShadowLod.empty() );
		return m_texture1DArrayShadowLod;
	}

	inline std::string const & KeywordsBase::getTexture1DArrayShadowOffset()const
	{
		REQUIRE( !m_texture1DArrayShadowOffset.empty() );
		return m_texture1DArrayShadowOffset;
	}

	inline std::string const & KeywordsBase::getTexture1DArrayShadowOffsetLod()const
	{
		REQUIRE( !m_texture1DArrayShadowOffsetLod.empty() );
		return m_texture1DArrayShadowOffsetLod;
	}

	inline std::string const & KeywordsBase::getTexture1DArrayShadowLodOffset()const
	{
		REQUIRE( !m_texture1DArrayShadowLodOffset.empty() );
		return m_texture1DArrayShadowLodOffset;
	}

	inline std::string const & KeywordsBase::getTexture2DArrayShadow()const
	{
		REQUIRE( !m_texture2DArrayShadow.empty() );
		return m_texture2DArrayShadow;
	}

	inline std::string const & KeywordsBase::getTexture2DArrayShadowLod()const
	{
		REQUIRE( !m_texture2DArrayShadowLod.empty() );
		return m_texture2DArrayShadowLod;
	}

	inline std::string const & KeywordsBase::getTexture2DArrayShadowOffset()const
	{
		REQUIRE( !m_texture2DArrayShadowOffset.empty() );
		return m_texture2DArrayShadowOffset;
	}

	inline std::string const & KeywordsBase::getTexture2DArrayShadowOffsetLod()const
	{
		REQUIRE( !m_texture2DArrayShadowOffsetLod.empty() );
		return m_texture2DArrayShadowOffsetLod;
	}

	inline std::string const & KeywordsBase::getTexture2DArrayShadowLodOffset()const
	{
		REQUIRE( !m_texture2DArrayShadowLodOffset.empty() );
		return m_texture2DArrayShadowLodOffset;
	}

	inline std::string const & KeywordsBase::getTextureCubeArrayShadow()const
	{
		REQUIRE( !m_textureCubeArrayShadow.empty() );
		return m_textureCubeArrayShadow;
	}

	inline std::string const & KeywordsBase::getTextureCubeArrayShadowLod()const
	{
		REQUIRE( !m_textureCubeArrayShadowLod.empty() );
		return m_textureCubeArrayShadowLod;
	}

	inline std::string const & KeywordsBase::getTexelFetchBuffer()const
	{
		REQUIRE( !m_texelFetchBuffer.empty() );
		return m_texelFetchBuffer;
	}

	inline std::string const & KeywordsBase::getTexelFetch1D()const
	{
		REQUIRE( !m_texelFetch1D.empty() );
		return m_texelFetch1D;
	}

	inline std::string const & KeywordsBase::getTexelFetch2D()const
	{
		REQUIRE( !m_texelFetch2D.empty() );
		return m_texelFetch2D;
	}

	inline std::string const & KeywordsBase::getTexelFetch3D()const
	{
	...
	public:
		...
		std::string getLayout( uint32_t CU_PARAM_UNUSED( index ) )const override
		{
			return cuT( "" );
		}

		std::string getFragData( uint32_t index )const override
		{
	...
	public:
		...
		std::string getFragData( uint32_t CU_PARAM_UNUSED( index ) )const override
		{
			return cuT( "" );
		}
	...
	public:
		...
		std::string getLayout( uint32_t index )const override
		{
	...
	public:
		...
		std::string getUboLayout( Ubo::Layout layout, uint32_t index, uint32_t set )const override
		{
			static std::map< Ubo::Layout, std::string > LayoutName
			{
