...
#pragma region Input declaration
	...
	*/
	/**@{*/
	template< typename T >
	inline T EntryPointWriter::declInput( std::string name
		, uint32_t location
		, bool enabled )
	{
	...
	template< typename T >
	inline Array< T > EntryPointWriter::declInputArray( std::string name
		, uint32_t location
		, uint32_t dimension
		, bool enabled )
	{
...
#pragma region Output declaration
	...
	*/
	/**@{*/
	template< typename T >
	inline T EntryPointWriter::declOutput( std::string name
		, uint32_t location
		, bool enabled )
	{
	...
	template< typename T >
	inline Array< T > EntryPointWriter::declOutputArray( std::string name
		, uint32_t location
		, uint32_t dimension
		, bool enabled )
	{
