...
#pragma region Function and images related
	...
	*/
	/**@{*/
#	define Writer_StorageImageEx( Prefix, TypeName, Format, FormatName, Suffix )\
		template< ast::type::AccessKind AccessT >\
		using Prefix##TypeName##FormatName##T = Storage##TypeName##T< ast::type::ImageFormat::e##Format##Suffix, AccessT >;\
		using R##Prefix##TypeName##FormatName = R##TypeName##T< ast::type::ImageFormat::e##Format##Suffix >;\
		Writer_Parameter( R##Prefix##TypeName##FormatName );\
		Writer_ArrayParameter( R##Prefix##TypeName##FormatName );\
		using W##Prefix##TypeName##FormatName = W##TypeName##T< ast::type::ImageFormat::e##Format##Suffix >;\
		Writer_Parameter( W##Prefix##TypeName##FormatName );\
		Writer_ArrayParameter( W##Prefix##TypeName##FormatName );\
		using RW##Prefix##TypeName##FormatName = RW##TypeName##T< ast::type::ImageFormat::e##Format##Suffix >;\
		Writer_Parameter( RW##Prefix##TypeName##FormatName );\
		Writer_ArrayParameter( RW##Prefix##TypeName##FormatName )

#	define Writer_UniformImageEx( Prefix, Type, TypeName, Format, FormatName, Suffix )\
		using Prefix##Type##TypeName##FormatName = Type##TypeName##T< ast::type::ImageFormat::e##Format##Suffix >;\
		Writer_Parameter( Prefix##Type##TypeName##FormatName );\
		Writer_ArrayParameter( Prefix##Type##TypeName##FormatName )

#	define Writer_CombinedImageEx( Prefix, TypeName, Format, FormatName, Suffix )\
		Writer_UniformImageEx( Prefix, Combined, TypeName, Format, FormatName, Suffix )

#	define Writer_SampledImageEx( Prefix, TypeName, Format, FormatName, Suffix )\
		Writer_UniformImageEx( Prefix, Sampled, TypeName, Format, FormatName, Suffix )

#	define Writer_StorageImage( Prefix, TypeName, Format, Suffix )\
		Writer_StorageImageEx( Prefix, TypeName, Format, Format, Suffix )\

#	define Writer_CombinedImage( Prefix, TypeName, Format, Suffix )\
		Writer_CombinedImageEx( Prefix, TypeName, Format, Format, Suffix )

#	define Writer_SampledImage( Prefix, TypeName, Format, Suffix )\
		Writer_SampledImageEx( Prefix, TypeName, Format, Format, Suffix )

	Writer_StorageImageEx( , ImageBuffer, RgbaTypeless, Rgba, );
	Writer_StorageImageEx( , Image1D, RgbaTypeless, Rgba, );
	Writer_StorageImageEx( , Image2D, RgbaTypeless, Rgba, );
	Writer_StorageImageEx( , Image3D, RgbaTypeless, Rgba, );
	Writer_StorageImageEx( , ImageCube, RgbaTypeless, Rgba, );
	Writer_StorageImageEx( , Image1DArray, RgbaTypeless, Rgba, );
	Writer_StorageImageEx( , Image2DArray, RgbaTypeless, Rgba, );
	Writer_StorageImageEx( , ImageCubeArray, RgbaTypeless, Rgba, );
	Writer_StorageImageEx( , Image2DMS, RgbaTypeless, Rgba, );
	Writer_StorageImageEx( , Image2DMSArray, RgbaTypeless, Rgba, );
	Writer_CombinedImageEx( , ImageBuffer, RgbaTypeless, Rgba, );
	Writer_CombinedImageEx( , Image1D, RgbaTypeless, Rgba, );
	Writer_CombinedImageEx( , Image2D, RgbaTypeless, Rgba, );
	Writer_CombinedImageEx( , Image3D, RgbaTypeless, Rgba, );
	Writer_CombinedImageEx( , ImageCube, RgbaTypeless, Rgba, );
	Writer_CombinedImageEx( , Image1DArray, RgbaTypeless, Rgba, );
	Writer_CombinedImageEx( , Image2DArray, RgbaTypeless, Rgba, );
	Writer_CombinedImageEx( , ImageCubeArray, RgbaTypeless, Rgba, );
	Writer_CombinedImageEx( , Image2DMS, RgbaTypeless, Rgba, );
	Writer_CombinedImageEx( , Image2DMSArray, RgbaTypeless, Rgba, );
	Writer_SampledImageEx( , ImageBuffer, RgbaTypeless, Rgba, );
	Writer_SampledImageEx( , Image1D, RgbaTypeless, Rgba, );
	Writer_SampledImageEx( , Image2D, RgbaTypeless, Rgba, );
	Writer_SampledImageEx( , Image3D, RgbaTypeless, Rgba, );
	Writer_SampledImageEx( , ImageCube, RgbaTypeless, Rgba, );
	Writer_SampledImageEx( , Image1DArray, RgbaTypeless, Rgba, );
	Writer_SampledImageEx( , Image2DArray, RgbaTypeless, Rgba, );
	Writer_SampledImageEx( , ImageCubeArray, RgbaTypeless, Rgba, );
	Writer_SampledImageEx( , Image2DMS, RgbaTypeless, Rgba, );
	Writer_SampledImageEx( , Image2DMSArray, RgbaTypeless, Rgba, );
	Writer_StorageImageEx( , ImageBuffer, RgTypeless, Rg, );
	Writer_StorageImageEx( , Image1D, RgTypeless, Rg, );
	Writer_StorageImageEx( , Image2D, RgTypeless, Rg, );
	Writer_StorageImageEx( , Image3D, RgTypeless, Rg, );
	Writer_StorageImageEx( , ImageCube, RgTypeless, Rg, );
	Writer_StorageImageEx( , Image1DArray, RgTypeless, Rg, );
	Writer_StorageImageEx( , Image2DArray, RgTypeless, Rg, );
	Writer_StorageImageEx( , ImageCubeArray, RgTypeless, Rg, );
	Writer_StorageImageEx( , Image2DMS, RgTypeless, Rg, );
	Writer_StorageImageEx( , Image2DMSArray, RgTypeless, Rg, );
	Writer_CombinedImageEx( , ImageBuffer, RgTypeless, Rg, );
	Writer_CombinedImageEx( , Image1D, RgTypeless, Rg, );
	Writer_CombinedImageEx( , Image2D, RgTypeless, Rg, );
	Writer_CombinedImageEx( , Image3D, RgTypeless, Rg, );
	Writer_CombinedImageEx( , ImageCube, RgTypeless, Rg, );
	Writer_CombinedImageEx( , Image1DArray, RgTypeless, Rg, );
	Writer_CombinedImageEx( , Image2DArray, RgTypeless, Rg, );
	Writer_CombinedImageEx( , ImageCubeArray, RgTypeless, Rg, );
	Writer_CombinedImageEx( , Image2DMS, RgTypeless, Rg, );
	Writer_CombinedImageEx( , Image2DMSArray, RgTypeless, Rg, );
	Writer_SampledImageEx( , ImageBuffer, RgTypeless, Rg, );
	Writer_SampledImageEx( , Image1D, RgTypeless, Rg, );
	Writer_SampledImageEx( , Image2D, RgTypeless, Rg, );
	Writer_SampledImageEx( , Image3D, RgTypeless, Rg, );
	Writer_SampledImageEx( , ImageCube, RgTypeless, Rg, );
	Writer_SampledImageEx( , Image1DArray, RgTypeless, Rg, );
	Writer_SampledImageEx( , Image2DArray, RgTypeless, Rg, );
	Writer_SampledImageEx( , ImageCubeArray, RgTypeless, Rg, );
	Writer_SampledImageEx( , Image2DMS, RgTypeless, Rg, );
	Writer_SampledImageEx( , Image2DMSArray, RgTypeless, Rg, );
	Writer_StorageImageEx( , ImageBuffer, RTypeless, R, );
	Writer_StorageImageEx( , Image1D, RTypeless, R, );
	Writer_StorageImageEx( , Image2D, RTypeless, R, );
	Writer_StorageImageEx( , Image3D, RTypeless, R, );
	Writer_StorageImageEx( , ImageCube, RTypeless, R, );
	Writer_StorageImageEx( , Image1DArray, RTypeless, R, );
	Writer_StorageImageEx( , Image2DArray, RTypeless, R, );
	Writer_StorageImageEx( , ImageCubeArray, RTypeless, R, );
	Writer_StorageImageEx( , Image2DMS, RTypeless, R, );
	Writer_StorageImageEx( , Image2DMSArray, RTypeless, R, );
	Writer_CombinedImageEx( , ImageBuffer, RTypeless, R, );
	Writer_CombinedImageEx( , Image1D, RTypeless, R, );
	Writer_CombinedImageEx( , Image2D, RTypeless, R, );
	Writer_CombinedImageEx( , Image3D, RTypeless, R, );
	Writer_CombinedImageEx( , ImageCube, RTypeless, R, );
	Writer_CombinedImageEx( , Image1DArray, RTypeless, R, );
	Writer_CombinedImageEx( , Image2DArray, RTypeless, R, );
	Writer_CombinedImageEx( , ImageCubeArray, RTypeless, R, );
	Writer_CombinedImageEx( , Image2DMS, RTypeless, R, );
	Writer_CombinedImageEx( , Image2DMSArray, RTypeless, R, );
	Writer_SampledImageEx( , ImageBuffer, RTypeless, R, );
	Writer_SampledImageEx( , Image1D, RTypeless, R, );
	Writer_SampledImageEx( , Image2D, RTypeless, R, );
	Writer_SampledImageEx( , Image3D, RTypeless, R, );
	Writer_SampledImageEx( , ImageCube, RTypeless, R, );
	Writer_SampledImageEx( , Image1DArray, RTypeless, R, );
	Writer_SampledImageEx( , Image2DArray, RTypeless, R, );
	Writer_SampledImageEx( , ImageCubeArray, RTypeless, R, );
	Writer_SampledImageEx( , Image2DMS, RTypeless, R, );
	Writer_SampledImageEx( , Image2DMSArray, RTypeless, R, );
	...
	Writer_StorageImage( , ImageBuffer, R11fG11fB10f, );
	Writer_StorageImage( , Image1D, R11fG11fB10f, );
	Writer_StorageImage( , Image2D, R11fG11fB10f, );
	Writer_StorageImage( , Image3D, R11fG11fB10f, );
	Writer_StorageImage( , ImageCube, R11fG11fB10f, );
	Writer_StorageImage( , Image1DArray, R11fG11fB10f, );
	Writer_StorageImage( , Image2DArray, R11fG11fB10f, );
	Writer_StorageImage( , ImageCubeArray, R11fG11fB10f, );
	Writer_StorageImage( , Image2DMS, R11fG11fB10f, );
	Writer_StorageImage( , Image2DMSArray, R11fG11fB10f, );
	Writer_CombinedImage( , ImageBuffer, R11fG11fB10f, );
	Writer_CombinedImage( , Image1D, R11fG11fB10f, );
	Writer_CombinedImage( , Image2D, R11fG11fB10f, );
	Writer_CombinedImage( , Image3D, R11fG11fB10f, );
	Writer_CombinedImage( , ImageCube, R11fG11fB10f, );
	Writer_CombinedImage( , Image1DArray, R11fG11fB10f, );
	Writer_CombinedImage( , Image2DArray, R11fG11fB10f, );
	Writer_CombinedImage( , ImageCubeArray, R11fG11fB10f, );
	Writer_CombinedImage( , Image2DMS, R11fG11fB10f, );
	Writer_CombinedImage( , Image2DMSArray, R11fG11fB10f, );
	Writer_SampledImage( , ImageBuffer, R11fG11fB10f, );
	Writer_SampledImage( , Image1D, R11fG11fB10f, );
	Writer_SampledImage( , Image2D, R11fG11fB10f, );
	Writer_SampledImage( , Image3D, R11fG11fB10f, );
	Writer_SampledImage( , ImageCube, R11fG11fB10f, );
	Writer_SampledImage( , Image1DArray, R11fG11fB10f, );
	Writer_SampledImage( , Image2DArray, R11fG11fB10f, );
	Writer_SampledImage( , ImageCubeArray, R11fG11fB10f, );
	Writer_SampledImage( , Image2DMS, R11fG11fB10f, );
	Writer_SampledImage( , Image2DMSArray, R11fG11fB10f, );
	Writer_StorageImage( , ImageBuffer, Rgba16Snorm, );
	Writer_StorageImage( , Image1D, Rgba16Snorm, );
	Writer_StorageImage( , Image2D, Rgba16Snorm, );
	Writer_StorageImage( , Image3D, Rgba16Snorm, );
	Writer_StorageImage( , ImageCube, Rgba16Snorm, );
	Writer_StorageImage( , Image1DArray, Rgba16Snorm, );
	Writer_StorageImage( , Image2DArray, Rgba16Snorm, );
	Writer_StorageImage( , ImageCubeArray, Rgba16Snorm, );
	Writer_StorageImage( , Image2DMS, Rgba16Snorm, );
	Writer_StorageImage( , Image2DMSArray, Rgba16Snorm, );
	Writer_CombinedImage( , ImageBuffer, Rgba16Snorm, );
	Writer_CombinedImage( , Image1D, Rgba16Snorm, );
	Writer_CombinedImage( , Image2D, Rgba16Snorm, );
	Writer_CombinedImage( , Image3D, Rgba16Snorm, );
	Writer_CombinedImage( , ImageCube, Rgba16Snorm, );
	Writer_CombinedImage( , Image1DArray, Rgba16Snorm, );
	Writer_CombinedImage( , Image2DArray, Rgba16Snorm, );
	Writer_CombinedImage( , ImageCubeArray, Rgba16Snorm, );
	Writer_CombinedImage( , Image2DMS, Rgba16Snorm, );
	Writer_CombinedImage( , Image2DMSArray, Rgba16Snorm, );
	Writer_SampledImage( , ImageBuffer, Rgba16Snorm, );
	Writer_SampledImage( , Image1D, Rgba16Snorm, );
	Writer_SampledImage( , Image2D, Rgba16Snorm, );
	Writer_SampledImage( , Image3D, Rgba16Snorm, );
	Writer_SampledImage( , ImageCube, Rgba16Snorm, );
	Writer_SampledImage( , Image1DArray, Rgba16Snorm, );
	Writer_SampledImage( , Image2DArray, Rgba16Snorm, );
	Writer_SampledImage( , ImageCubeArray, Rgba16Snorm, );
	Writer_SampledImage( , Image2DMS, Rgba16Snorm, );
	Writer_SampledImage( , Image2DMSArray, Rgba16Snorm, );
	Writer_StorageImage( , ImageBuffer, Rgba16Unorm, );
	Writer_StorageImage( , Image1D, Rgba16Unorm, );
	Writer_StorageImage( , Image2D, Rgba16Unorm, );
	Writer_StorageImage( , Image3D, Rgba16Unorm, );
	Writer_StorageImage( , ImageCube, Rgba16Unorm, );
	Writer_StorageImage( , Image1DArray, Rgba16Unorm, );
	Writer_StorageImage( , Image2DArray, Rgba16Unorm, );
	Writer_StorageImage( , ImageCubeArray, Rgba16Unorm, );
	Writer_StorageImage( , Image2DMS, Rgba16Unorm, );
	Writer_StorageImage( , Image2DMSArray, Rgba16Unorm, );
	Writer_CombinedImage( , ImageBuffer, Rgba16Unorm, );
	Writer_CombinedImage( , Image1D, Rgba16Unorm, );
	Writer_CombinedImage( , Image2D, Rgba16Unorm, );
	Writer_CombinedImage( , Image3D, Rgba16Unorm, );
	Writer_CombinedImage( , ImageCube, Rgba16Unorm, );
	Writer_CombinedImage( , Image1DArray, Rgba16Unorm, );
	Writer_CombinedImage( , Image2DArray, Rgba16Unorm, );
	Writer_CombinedImage( , ImageCubeArray, Rgba16Unorm, );
	Writer_CombinedImage( , Image2DMS, Rgba16Unorm, );
	Writer_CombinedImage( , Image2DMSArray, Rgba16Unorm, );
	Writer_SampledImage( , ImageBuffer, Rgba16Unorm, );
	Writer_SampledImage( , Image1D, Rgba16Unorm, );
	Writer_SampledImage( , Image2D, Rgba16Unorm, );
	Writer_SampledImage( , Image3D, Rgba16Unorm, );
	Writer_SampledImage( , ImageCube, Rgba16Unorm, );
	Writer_SampledImage( , Image1DArray, Rgba16Unorm, );
	Writer_SampledImage( , Image2DArray, Rgba16Unorm, );
	Writer_SampledImage( , ImageCubeArray, Rgba16Unorm, );
	Writer_SampledImage( , Image2DMS, Rgba16Unorm, );
	Writer_SampledImage( , Image2DMSArray, Rgba16Unorm, );
	Writer_StorageImage( , ImageBuffer, Rgba8Snorm, );
	Writer_StorageImage( , Image1D, Rgba8Snorm, );
	Writer_StorageImage( , Image2D, Rgba8Snorm, );
	Writer_StorageImage( , Image3D, Rgba8Snorm, );
	Writer_StorageImage( , ImageCube, Rgba8Snorm, );
	Writer_StorageImage( , Image1DArray, Rgba8Snorm, );
	Writer_StorageImage( , Image2DArray, Rgba8Snorm, );
	Writer_StorageImage( , ImageCubeArray, Rgba8Snorm, );
	Writer_StorageImage( , Image2DMS, Rgba8Snorm, );
	Writer_StorageImage( , Image2DMSArray, Rgba8Snorm, );
	Writer_CombinedImage( , ImageBuffer, Rgba8Snorm, );
	Writer_CombinedImage( , Image1D, Rgba8Snorm, );
	Writer_CombinedImage( , Image2D, Rgba8Snorm, );
	Writer_CombinedImage( , Image3D, Rgba8Snorm, );
	Writer_CombinedImage( , ImageCube, Rgba8Snorm, );
	Writer_CombinedImage( , Image1DArray, Rgba8Snorm, );
	Writer_CombinedImage( , Image2DArray, Rgba8Snorm, );
	Writer_CombinedImage( , ImageCubeArray, Rgba8Snorm, );
	Writer_CombinedImage( , Image2DMS, Rgba8Snorm, );
	Writer_CombinedImage( , Image2DMSArray, Rgba8Snorm, );
	Writer_SampledImage( , ImageBuffer, Rgba8Snorm, );
	Writer_SampledImage( , Image1D, Rgba8Snorm, );
	Writer_SampledImage( , Image2D, Rgba8Snorm, );
	Writer_SampledImage( , Image3D, Rgba8Snorm, );
	Writer_SampledImage( , ImageCube, Rgba8Snorm, );
	Writer_SampledImage( , Image1DArray, Rgba8Snorm, );
	Writer_SampledImage( , Image2DArray, Rgba8Snorm, );
	Writer_SampledImage( , ImageCubeArray, Rgba8Snorm, );
	Writer_SampledImage( , Image2DMS, Rgba8Snorm, );
	Writer_SampledImage( , Image2DMSArray, Rgba8Snorm, );
	Writer_StorageImage( , ImageBuffer, Rgba8Unorm, );
	Writer_StorageImage( , Image1D, Rgba8Unorm, );
	Writer_StorageImage( , Image2D, Rgba8Unorm, );
	Writer_StorageImage( , Image3D, Rgba8Unorm, );
	Writer_StorageImage( , ImageCube, Rgba8Unorm, );
	Writer_StorageImage( , Image1DArray, Rgba8Unorm, );
	Writer_StorageImage( , Image2DArray, Rgba8Unorm, );
	Writer_StorageImage( , ImageCubeArray, Rgba8Unorm, );
	Writer_StorageImage( , Image2DMS, Rgba8Unorm, );
	Writer_StorageImage( , Image2DMSArray, Rgba8Unorm, );
	Writer_CombinedImage( , ImageBuffer, Rgba8Unorm, );
	Writer_CombinedImage( , Image1D, Rgba8Unorm, );
	Writer_CombinedImage( , Image2D, Rgba8Unorm, );
	Writer_CombinedImage( , Image3D, Rgba8Unorm, );
	Writer_CombinedImage( , ImageCube, Rgba8Unorm, );
	Writer_CombinedImage( , Image1DArray, Rgba8Unorm, );
	Writer_CombinedImage( , Image2DArray, Rgba8Unorm, );
	Writer_CombinedImage( , ImageCubeArray, Rgba8Unorm, );
	Writer_CombinedImage( , Image2DMS, Rgba8Unorm, );
	Writer_CombinedImage( , Image2DMSArray, Rgba8Unorm, );
	Writer_SampledImage( , ImageBuffer, Rgba8Unorm, );
	Writer_SampledImage( , Image1D, Rgba8Unorm, );
	Writer_SampledImage( , Image2D, Rgba8Unorm, );
	Writer_SampledImage( , Image3D, Rgba8Unorm, );
	Writer_SampledImage( , ImageCube, Rgba8Unorm, );
	Writer_SampledImage( , Image1DArray, Rgba8Unorm, );
	Writer_SampledImage( , Image2DArray, Rgba8Unorm, );
	Writer_SampledImage( , ImageCubeArray, Rgba8Unorm, );
	Writer_SampledImage( , Image2DMS, Rgba8Unorm, );
	Writer_SampledImage( , Image2DMSArray, Rgba8Unorm, );
	Writer_StorageImage( , ImageBuffer, Rgb10A2, Unorm );
	Writer_StorageImage( , Image1D, Rgb10A2, Unorm );
	Writer_StorageImage( , Image2D, Rgb10A2, Unorm );
	Writer_StorageImage( , Image3D, Rgb10A2, Unorm );
	Writer_StorageImage( , ImageCube, Rgb10A2, Unorm );
	Writer_StorageImage( , Image1DArray, Rgb10A2, Unorm );
	Writer_StorageImage( , Image2DArray, Rgb10A2, Unorm );
	Writer_StorageImage( , ImageCubeArray, Rgb10A2, Unorm );
	Writer_StorageImage( , Image2DMS, Rgb10A2, Unorm );
	Writer_StorageImage( , Image2DMSArray, Rgb10A2, Unorm );
	Writer_CombinedImage( , ImageBuffer, Rgb10A2, Unorm );
	Writer_CombinedImage( , Image1D, Rgb10A2, Unorm );
	Writer_CombinedImage( , Image2D, Rgb10A2, Unorm );
	Writer_CombinedImage( , Image3D, Rgb10A2, Unorm );
	Writer_CombinedImage( , ImageCube, Rgb10A2, Unorm );
	Writer_CombinedImage( , Image1DArray, Rgb10A2, Unorm );
	Writer_CombinedImage( , Image2DArray, Rgb10A2, Unorm );
	Writer_CombinedImage( , ImageCubeArray, Rgb10A2, Unorm );
	Writer_CombinedImage( , Image2DMS, Rgb10A2, Unorm );
	Writer_CombinedImage( , Image2DMSArray, Rgb10A2, Unorm );
	Writer_SampledImage( , ImageBuffer, Rgb10A2, Unorm );
	Writer_SampledImage( , Image1D, Rgb10A2, Unorm );
	Writer_SampledImage( , Image2D, Rgb10A2, Unorm );
	Writer_SampledImage( , Image3D, Rgb10A2, Unorm );
	Writer_SampledImage( , ImageCube, Rgb10A2, Unorm );
	Writer_SampledImage( , Image1DArray, Rgb10A2, Unorm );
	Writer_SampledImage( , Image2DArray, Rgb10A2, Unorm );
	Writer_SampledImage( , ImageCubeArray, Rgb10A2, Unorm );
	Writer_SampledImage( , Image2DMS, Rgb10A2, Unorm );
	Writer_SampledImage( , Image2DMSArray, Rgb10A2, Unorm );
	...
	Writer_StorageImage( , ImageBuffer, Rg16Snorm, );
	Writer_StorageImage( , Image1D, Rg16Snorm, );
	Writer_StorageImage( , Image2D, Rg16Snorm, );
	Writer_StorageImage( , Image3D, Rg16Snorm, );
	Writer_StorageImage( , ImageCube, Rg16Snorm, );
	Writer_StorageImage( , Image1DArray, Rg16Snorm, );
	Writer_StorageImage( , Image2DArray, Rg16Snorm, );
	Writer_StorageImage( , ImageCubeArray, Rg16Snorm, );
	Writer_StorageImage( , Image2DMS, Rg16Snorm, );
	Writer_StorageImage( , Image2DMSArray, Rg16Snorm, );
	Writer_CombinedImage( , ImageBuffer, Rg16Snorm, );
	Writer_CombinedImage( , Image1D, Rg16Snorm, );
	Writer_CombinedImage( , Image2D, Rg16Snorm, );
	Writer_CombinedImage( , Image3D, Rg16Snorm, );
	Writer_CombinedImage( , ImageCube, Rg16Snorm, );
	Writer_CombinedImage( , Image1DArray, Rg16Snorm, );
	Writer_CombinedImage( , Image2DArray, Rg16Snorm, );
	Writer_CombinedImage( , ImageCubeArray, Rg16Snorm, );
	Writer_CombinedImage( , Image2DMS, Rg16Snorm, );
	Writer_CombinedImage( , Image2DMSArray, Rg16Snorm, );
	Writer_SampledImage( , ImageBuffer, Rg16Snorm, );
	Writer_SampledImage( , Image1D, Rg16Snorm, );
	Writer_SampledImage( , Image2D, Rg16Snorm, );
	Writer_SampledImage( , Image3D, Rg16Snorm, );
	Writer_SampledImage( , ImageCube, Rg16Snorm, );
	Writer_SampledImage( , Image1DArray, Rg16Snorm, );
	Writer_SampledImage( , Image2DArray, Rg16Snorm, );
	Writer_SampledImage( , ImageCubeArray, Rg16Snorm, );
	Writer_SampledImage( , Image2DMS, Rg16Snorm, );
	Writer_SampledImage( , Image2DMSArray, Rg16Snorm, );
	Writer_StorageImage( , ImageBuffer, Rg16Unorm, );
	Writer_StorageImage( , Image1D, Rg16Unorm, );
	Writer_StorageImage( , Image2D, Rg16Unorm, );
	Writer_StorageImage( , Image3D, Rg16Unorm, );
	Writer_StorageImage( , ImageCube, Rg16Unorm, );
	Writer_StorageImage( , Image1DArray, Rg16Unorm, );
	Writer_StorageImage( , Image2DArray, Rg16Unorm, );
	Writer_StorageImage( , ImageCubeArray, Rg16Unorm, );
	Writer_StorageImage( , Image2DMS, Rg16Unorm, );
	Writer_StorageImage( , Image2DMSArray, Rg16Unorm, );
	Writer_CombinedImage( , ImageBuffer, Rg16Unorm, );
	Writer_CombinedImage( , Image1D, Rg16Unorm, );
	Writer_CombinedImage( , Image2D, Rg16Unorm, );
	Writer_CombinedImage( , Image3D, Rg16Unorm, );
	Writer_CombinedImage( , ImageCube, Rg16Unorm, );
	Writer_CombinedImage( , Image1DArray, Rg16Unorm, );
	Writer_CombinedImage( , Image2DArray, Rg16Unorm, );
	Writer_CombinedImage( , ImageCubeArray, Rg16Unorm, );
	Writer_CombinedImage( , Image2DMS, Rg16Unorm, );
	Writer_CombinedImage( , Image2DMSArray, Rg16Unorm, );
	Writer_SampledImage( , ImageBuffer, Rg16Unorm, );
	Writer_SampledImage( , Image1D, Rg16Unorm, );
	Writer_SampledImage( , Image2D, Rg16Unorm, );
	Writer_SampledImage( , Image3D, Rg16Unorm, );
	Writer_SampledImage( , ImageCube, Rg16Unorm, );
	Writer_SampledImage( , Image1DArray, Rg16Unorm, );
	Writer_SampledImage( , Image2DArray, Rg16Unorm, );
	Writer_SampledImage( , ImageCubeArray, Rg16Unorm, );
	Writer_SampledImage( , Image2DMS, Rg16Unorm, );
	Writer_SampledImage( , Image2DMSArray, Rg16Unorm, );
	Writer_StorageImage( , ImageBuffer, Rg8Snorm, );
	Writer_StorageImage( , Image1D, Rg8Snorm, );
	Writer_StorageImage( , Image2D, Rg8Snorm, );
	Writer_StorageImage( , Image3D, Rg8Snorm, );
	Writer_StorageImage( , ImageCube, Rg8Snorm, );
	Writer_StorageImage( , Image1DArray, Rg8Snorm, );
	Writer_StorageImage( , Image2DArray, Rg8Snorm, );
	Writer_StorageImage( , ImageCubeArray, Rg8Snorm, );
	Writer_StorageImage( , Image2DMS, Rg8Snorm, );
	Writer_StorageImage( , Image2DMSArray, Rg8Snorm, );
	Writer_CombinedImage( , ImageBuffer, Rg8Snorm, );
	Writer_CombinedImage( , Image1D, Rg8Snorm, );
	Writer_CombinedImage( , Image2D, Rg8Snorm, );
	Writer_CombinedImage( , Image3D, Rg8Snorm, );
	Writer_CombinedImage( , ImageCube, Rg8Snorm, );
	Writer_CombinedImage( , Image1DArray, Rg8Snorm, );
	Writer_CombinedImage( , Image2DArray, Rg8Snorm, );
	Writer_CombinedImage( , ImageCubeArray, Rg8Snorm, );
	Writer_CombinedImage( , Image2DMS, Rg8Snorm, );
	Writer_CombinedImage( , Image2DMSArray, Rg8Snorm, );
	Writer_SampledImage( , ImageBuffer, Rg8Snorm, );
	Writer_SampledImage( , Image1D, Rg8Snorm, );
	Writer_SampledImage( , Image2D, Rg8Snorm, );
	Writer_SampledImage( , Image3D, Rg8Snorm, );
	Writer_SampledImage( , ImageCube, Rg8Snorm, );
	Writer_SampledImage( , Image1DArray, Rg8Snorm, );
	Writer_SampledImage( , Image2DArray, Rg8Snorm, );
	Writer_SampledImage( , ImageCubeArray, Rg8Snorm, );
	Writer_SampledImage( , Image2DMS, Rg8Snorm, );
	Writer_SampledImage( , Image2DMSArray, Rg8Snorm, );
	Writer_StorageImage( , ImageBuffer, Rg8Unorm, );
	Writer_StorageImage( , Image1D, Rg8Unorm, );
	Writer_StorageImage( , Image2D, Rg8Unorm, );
	Writer_StorageImage( , Image3D, Rg8Unorm, );
	Writer_StorageImage( , ImageCube, Rg8Unorm, );
	Writer_StorageImage( , Image1DArray, Rg8Unorm, );
	Writer_StorageImage( , Image2DArray, Rg8Unorm, );
	Writer_StorageImage( , ImageCubeArray, Rg8Unorm, );
	Writer_StorageImage( , Image2DMS, Rg8Unorm, );
	Writer_StorageImage( , Image2DMSArray, Rg8Unorm, );
	Writer_CombinedImage( , ImageBuffer, Rg8Unorm, );
	Writer_CombinedImage( , Image1D, Rg8Unorm, );
	Writer_CombinedImage( , Image2D, Rg8Unorm, );
	Writer_CombinedImage( , Image3D, Rg8Unorm, );
	Writer_CombinedImage( , ImageCube, Rg8Unorm, );
	Writer_CombinedImage( , Image1DArray, Rg8Unorm, );
	Writer_CombinedImage( , Image2DArray, Rg8Unorm, );
	Writer_CombinedImage( , ImageCubeArray, Rg8Unorm, );
	Writer_CombinedImage( , Image2DMS, Rg8Unorm, );
	Writer_CombinedImage( , Image2DMSArray, Rg8Unorm, );
	Writer_SampledImage( , ImageBuffer, Rg8Unorm, );
	Writer_SampledImage( , Image1D, Rg8Unorm, );
	Writer_SampledImage( , Image2D, Rg8Unorm, );
	Writer_SampledImage( , Image3D, Rg8Unorm, );
	Writer_SampledImage( , ImageCube, Rg8Unorm, );
	Writer_SampledImage( , Image1DArray, Rg8Unorm, );
	Writer_SampledImage( , Image2DArray, Rg8Unorm, );
	Writer_SampledImage( , ImageCubeArray, Rg8Unorm, );
	Writer_SampledImage( , Image2DMS, Rg8Unorm, );
	Writer_SampledImage( , Image2DMSArray, Rg8Unorm, );
	...
	Writer_StorageImage( , ImageBuffer, R16Snorm, );
	Writer_StorageImage( , Image1D, R16Snorm, );
	Writer_StorageImage( , Image2D, R16Snorm, );
	Writer_StorageImage( , Image3D, R16Snorm, );
	Writer_StorageImage( , ImageCube, R16Snorm, );
	Writer_StorageImage( , Image1DArray, R16Snorm, );
	Writer_StorageImage( , Image2DArray, R16Snorm, );
	Writer_StorageImage( , ImageCubeArray, R16Snorm, );
	Writer_StorageImage( , Image2DMS, R16Snorm, );
	Writer_StorageImage( , Image2DMSArray, R16Snorm, );
	Writer_CombinedImage( , ImageBuffer, R16Snorm, );
	Writer_CombinedImage( , Image1D, R16Snorm, );
	Writer_CombinedImage( , Image2D, R16Snorm, );
	Writer_CombinedImage( , Image3D, R16Snorm, );
	Writer_CombinedImage( , ImageCube, R16Snorm, );
	Writer_CombinedImage( , Image1DArray, R16Snorm, );
	Writer_CombinedImage( , Image2DArray, R16Snorm, );
	Writer_CombinedImage( , ImageCubeArray, R16Snorm, );
	Writer_CombinedImage( , Image2DMS, R16Snorm, );
	Writer_CombinedImage( , Image2DMSArray, R16Snorm, );
	Writer_SampledImage( , ImageBuffer, R16Snorm, );
	Writer_SampledImage( , Image1D, R16Snorm, );
	Writer_SampledImage( , Image2D, R16Snorm, );
	Writer_SampledImage( , Image3D, R16Snorm, );
	Writer_SampledImage( , ImageCube, R16Snorm, );
	Writer_SampledImage( , Image1DArray, R16Snorm, );
	Writer_SampledImage( , Image2DArray, R16Snorm, );
	Writer_SampledImage( , ImageCubeArray, R16Snorm, );
	Writer_SampledImage( , Image2DMS, R16Snorm, );
	Writer_SampledImage( , Image2DMSArray, R16Snorm, );
	Writer_StorageImage( , ImageBuffer, R16Unorm, );
	Writer_StorageImage( , Image1D, R16Unorm, );
	Writer_StorageImage( , Image2D, R16Unorm, );
	Writer_StorageImage( , Image3D, R16Unorm, );
	Writer_StorageImage( , ImageCube, R16Unorm, );
	Writer_StorageImage( , Image1DArray, R16Unorm, );
	Writer_StorageImage( , Image2DArray, R16Unorm, );
	Writer_StorageImage( , ImageCubeArray, R16Unorm, );
	Writer_StorageImage( , Image2DMS, R16Unorm, );
	Writer_StorageImage( , Image2DMSArray, R16Unorm, );
	Writer_CombinedImage( , ImageBuffer, R16Unorm, );
	Writer_CombinedImage( , Image1D, R16Unorm, );
	Writer_CombinedImage( , Image2D, R16Unorm, );
	Writer_CombinedImage( , Image3D, R16Unorm, );
	Writer_CombinedImage( , ImageCube, R16Unorm, );
	Writer_CombinedImage( , Image1DArray, R16Unorm, );
	Writer_CombinedImage( , Image2DArray, R16Unorm, );
	Writer_CombinedImage( , ImageCubeArray, R16Unorm, );
	Writer_CombinedImage( , Image2DMS, R16Unorm, );
	Writer_CombinedImage( , Image2DMSArray, R16Unorm, );
	Writer_SampledImage( , ImageBuffer, R16Unorm, );
	Writer_SampledImage( , Image1D, R16Unorm, );
	Writer_SampledImage( , Image2D, R16Unorm, );
	Writer_SampledImage( , Image3D, R16Unorm, );
	Writer_SampledImage( , ImageCube, R16Unorm, );
	Writer_SampledImage( , Image1DArray, R16Unorm, );
	Writer_SampledImage( , Image2DArray, R16Unorm, );
	Writer_SampledImage( , ImageCubeArray, R16Unorm, );
	Writer_SampledImage( , Image2DMS, R16Unorm, );
	Writer_SampledImage( , Image2DMSArray, R16Unorm, );
	Writer_StorageImage( , ImageBuffer, R8Snorm, );
	Writer_StorageImage( , Image1D, R8Snorm, );
	Writer_StorageImage( , Image2D, R8Snorm, );
	Writer_StorageImage( , Image3D, R8Snorm, );
	Writer_StorageImage( , ImageCube, R8Snorm, );
	Writer_StorageImage( , Image1DArray, R8Snorm, );
	Writer_StorageImage( , Image2DArray, R8Snorm, );
	Writer_StorageImage( , ImageCubeArray, R8Snorm, );
	Writer_StorageImage( , Image2DMS, R8Snorm, );
	Writer_StorageImage( , Image2DMSArray, R8Snorm, );
	Writer_CombinedImage( , ImageBuffer, R8Snorm, );
	Writer_CombinedImage( , Image1D, R8Snorm, );
	Writer_CombinedImage( , Image2D, R8Snorm, );
	Writer_CombinedImage( , Image3D, R8Snorm, );
	Writer_CombinedImage( , ImageCube, R8Snorm, );
	Writer_CombinedImage( , Image1DArray, R8Snorm, );
	Writer_CombinedImage( , Image2DArray, R8Snorm, );
	Writer_CombinedImage( , ImageCubeArray, R8Snorm, );
	Writer_CombinedImage( , Image2DMS, R8Snorm, );
	Writer_CombinedImage( , Image2DMSArray, R8Snorm, );
	Writer_SampledImage( , ImageBuffer, R8Snorm, );
	Writer_SampledImage( , Image1D, R8Snorm, );
	Writer_SampledImage( , Image2D, R8Snorm, );
	Writer_SampledImage( , Image3D, R8Snorm, );
	Writer_SampledImage( , ImageCube, R8Snorm, );
	Writer_SampledImage( , Image1DArray, R8Snorm, );
	Writer_SampledImage( , Image2DArray, R8Snorm, );
	Writer_SampledImage( , ImageCubeArray, R8Snorm, );
	Writer_SampledImage( , Image2DMS, R8Snorm, );
	Writer_SampledImage( , Image2DMSArray, R8Snorm, );
	Writer_StorageImage( , ImageBuffer, R8Unorm, );
	Writer_StorageImage( , Image1D, R8Unorm, );
	Writer_StorageImage( , Image2D, R8Unorm, );
	Writer_StorageImage( , Image3D, R8Unorm, );
	Writer_StorageImage( , ImageCube, R8Unorm, );
	Writer_StorageImage( , Image1DArray, R8Unorm, );
	Writer_StorageImage( , Image2DArray, R8Unorm, );
	Writer_StorageImage( , ImageCubeArray, R8Unorm, );
	Writer_StorageImage( , Image2DMS, R8Unorm, );
	Writer_StorageImage( , Image2DMSArray, R8Unorm, );
	Writer_CombinedImage( , ImageBuffer, R8Unorm, );
	Writer_CombinedImage( , Image1D, R8Unorm, );
	Writer_CombinedImage( , Image2D, R8Unorm, );
	Writer_CombinedImage( , Image3D, R8Unorm, );
	Writer_CombinedImage( , ImageCube, R8Unorm, );
	Writer_CombinedImage( , Image1DArray, R8Unorm, );
	Writer_CombinedImage( , Image2DArray, R8Unorm, );
	Writer_CombinedImage( , ImageCubeArray, R8Unorm, );
	Writer_CombinedImage( , Image2DMS, R8Unorm, );
	Writer_CombinedImage( , Image2DMSArray, R8Unorm, );
	Writer_SampledImage( , ImageBuffer, R8Unorm, );
	Writer_SampledImage( , Image1D, R8Unorm, );
	Writer_SampledImage( , Image2D, R8Unorm, );
	Writer_SampledImage( , Image3D, R8Unorm, );
	Writer_SampledImage( , ImageCube, R8Unorm, );
	Writer_SampledImage( , Image1DArray, R8Unorm, );
	Writer_SampledImage( , Image2DArray, R8Unorm, );
	Writer_SampledImage( , ImageCubeArray, R8Unorm, );
	Writer_SampledImage( , Image2DMS, R8Unorm, );
	Writer_SampledImage( , Image2DMSArray, R8Unorm, );
	...
	Writer_StorageImage( U, ImageBuffer, Rgb10A2, u );
	Writer_StorageImage( U, Image1D, Rgb10A2, u );
	Writer_StorageImage( U, Image2D, Rgb10A2, u );
	Writer_StorageImage( U, Image3D, Rgb10A2, u );
	Writer_StorageImage( U, ImageCube, Rgb10A2, u );
	Writer_StorageImage( U, Image1DArray, Rgb10A2, u );
	Writer_StorageImage( U, Image2DArray, Rgb10A2, u );
	Writer_StorageImage( U, ImageCubeArray, Rgb10A2, u );
	Writer_StorageImage( U, Image2DMS, Rgb10A2, u );
	Writer_StorageImage( U, Image2DMSArray, Rgb10A2, u );
	Writer_CombinedImage( U, ImageBuffer, Rgb10A2, u );
	Writer_CombinedImage( U, Image1D, Rgb10A2, u );
	Writer_CombinedImage( U, Image2D, Rgb10A2, u );
	Writer_CombinedImage( U, Image3D, Rgb10A2, u );
	Writer_CombinedImage( U, ImageCube, Rgb10A2, u );
	Writer_CombinedImage( U, Image1DArray, Rgb10A2, u );
	Writer_CombinedImage( U, Image2DArray, Rgb10A2, u );
	Writer_CombinedImage( U, ImageCubeArray, Rgb10A2, u );
	Writer_CombinedImage( U, Image2DMS, Rgb10A2, u );
	Writer_CombinedImage( U, Image2DMSArray, Rgb10A2, u );
	Writer_SampledImage( U, ImageBuffer, Rgb10A2, u );
	Writer_SampledImage( U, Image1D, Rgb10A2, u );
	Writer_SampledImage( U, Image2D, Rgb10A2, u );
	Writer_SampledImage( U, Image3D, Rgb10A2, u );
	Writer_SampledImage( U, ImageCube, Rgb10A2, u );
	Writer_SampledImage( U, Image1DArray, Rgb10A2, u );
	Writer_SampledImage( U, Image2DArray, Rgb10A2, u );
	Writer_SampledImage( U, ImageCubeArray, Rgb10A2, u );
	Writer_SampledImage( U, Image2DMS, Rgb10A2, u );
	Writer_SampledImage( U, Image2DMSArray, Rgb10A2, u );
