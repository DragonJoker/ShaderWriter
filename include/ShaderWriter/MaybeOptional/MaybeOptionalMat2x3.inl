...
namespace sdw
{
	...
	template< typename ValueT >
	inline MaybeOptional< Mat2x3T< ValueT > > & MaybeOptional< Mat2x3T< ValueT > >::operator=( Mat2x3T< ValueT > const & rhs )
	{
		if ( isEnabled() )
		{
	...
	template< typename ValueT >
	inline MaybeOptional< Mat2x3T< ValueT > > & MaybeOptional< Mat2x3T< ValueT > >::operator=( Optional< Mat2x3T< ValueT > > const & rhs )
	{
	...
	template< typename ValueT >
	inline MaybeOptional< Mat2x3T< ValueT > > & MaybeOptional< Mat2x3T< ValueT > >::operator=( MaybeOptional< Mat2x3T< ValueT > > const & rhs )
	{
		if ( isEnabled() && rhs.isEnabled() )
		{
			Mat2x3T< ValueT >::operator=( rhs );
	...
	template< typename ValueT >
	inline Optional< Mat2x3T< ValueT > > & Optional< Mat2x3T< ValueT > >::operator=( MaybeOptional< Mat2x3T< ValueT > > const & rhs )
	{
		if ( isEnabled() && rhs.isEnabled() )
		{
			Mat2x3T< ValueT >::operator=( rhs );
