...
namespace sdw
{
	...
	template< typename ValueT >
	Optional< Mat3x4T< ValueT > >::Optional( Mat3x4T< ValueT > const & other
		, bool enabled )
		: Mat3x4T< ValueT >{ other }
		, m_enabled{ enabled }
	{
	}
	...
	Optional< Vec3T< ValueT > > Optional< Mat3x4T< ValueT > >::operator[]( IndexT const & rhs )const
	{
