...
namespace sdw
{
	...
	*/
	...
	template< template< ast::var::Flag FlagT > typename InT
		, template< ast::var::Flag FlagT > typename OutT >
	inline void TraditionalGraphicsWriter::implementEntryPointT( FragmentMainFuncT< InT, OutT > const & function )
	{
	...
	template< template< ast::var::Flag FlagT > typename InT
		, template< ast::var::Flag FlagT > typename OutT >
	inline void TraditionalGraphicsWriter::implementEntryPointT( ast::FragmentOrigin origin
	...
	template< template< ast::var::Flag FlagT > typename InT
		, template< ast::var::Flag FlagT > typename OutT >
	inline void TraditionalGraphicsWriter::implementEntryPointT( FragmentInT< InT > in
	...
	*/
	/**@{*/
	template< typename T >
	inline T TraditionalGraphicsWriter::declBlendOutput( std::string name
		, uint32_t location
		, uint32_t blendIndex
		, bool enabled )
	{
	...
	template< typename T >
	inline Array< T > TraditionalGraphicsWriter::declBlendOutputArray( std::string name
		, uint32_t location
		, uint32_t blendIndex
		, uint32_t dimension
		, bool enabled )
