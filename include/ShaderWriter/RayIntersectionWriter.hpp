...
namespace sdw
{
	...
	*/
	...
	public:
		...
		explicit RayIntersectionWriter( ShaderAllocator * allocator = nullptr )
			: RayIntersectionWriter{ uint32_t( 0u ), allocator }
		{
		}

		explicit RayIntersectionWriter( ast::stmt::FunctionFlag flag
			, ShaderAllocator * allocator = nullptr )
			: RayIntersectionWriter{ uint32_t( flag ), allocator }
		{
		}

		RayIntersectionWriter( ShaderBuilder & builder
