...
namespace sdw
{
	...
	Vec3T< ValueT >::Vec3T( ShaderWriter & writer
		, expr::ExprPtr expr
		, bool enabled )
	...
	ReturnWrapperT< ValueT > Vec3T< ValueT >::operator[]( IndexT const & offset )const
	{
		return writeBinOperator< ValueT >( *this, offset, sdw::makeArrayAccess );
	}

	template< typename ValueT >
	ReturnWrapperT< ValueT > Vec3T< ValueT >::operator[]( int32_t offset )const
	{
		return writeBinOperator< ValueT >( *this, offset, sdw::makeArrayAccess );
	}

	template< typename ValueT >
	ReturnWrapperT< ValueT > Vec3T< ValueT >::operator[]( uint32_t offset )const
	{
		return writeBinOperator< ValueT >( *this, offset, sdw::makeArrayAccess );
	}

	template< typename ValueT >
	ReturnWrapperT< Vec3T< ValueT > > Vec3T< ValueT >::operator+=( Vec3T< ValueT > const & rhs )
	{
		return writeAssignOperator< Vec3T< ValueT > >( *this, rhs, sdw::makeAddAssign );
	}

	template< typename ValueT >
	ReturnWrapperT< Vec3T< ValueT > > Vec3T< ValueT >::operator-=( Vec3T< ValueT > const & rhs )
	{
		return writeAssignOperator< Vec3T< ValueT > >( *this, rhs, sdw::makeMinusAssign );
	}

	template< typename ValueT >
	ReturnWrapperT< Vec3T< ValueT > > Vec3T< ValueT >::operator*=( Vec3T< ValueT > const & rhs )
	{
		return writeAssignOperator< Vec3T< ValueT > >( *this, rhs, sdw::makeTimesAssign );
	}

	template< typename ValueT >
	ReturnWrapperT< Vec3T< ValueT > > Vec3T< ValueT >::operator/=( Vec3T< ValueT > const & rhs )
	{
		return writeAssignOperator< Vec3T< ValueT > >( *this, rhs, sdw::makeDivideAssign );
	}

	template< typename ValueT >
	ReturnWrapperT< Vec3T< ValueT > > Vec3T< ValueT >::operator+=( ValueT const & rhs )
	{
		return writeAssignOperator< Vec3T< ValueT > >( *this, rhs, sdw::makeAddAssign );
	}
	...
	template< typename ValueT >
	ReturnWrapperT< Vec3T< ValueT > > Vec3T< ValueT >::operator-()const
	{
	...
	template< typename ValueT >
	ast::type::TypePtr Vec3T< ValueT >::makeType( ast::type::TypesCache & cache )
	{
	...
	template< typename ValueT >
	ReturnWrapperT< Vec3T< Boolean > > operator==( Vec3T< ValueT > const & lhs, Vec3T< ValueT > const & rhs )
	{
