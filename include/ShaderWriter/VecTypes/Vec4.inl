...
namespace sdw
{
	...
	Vec4T< ValueT >::Vec4T( ShaderWriter & writer
		, expr::ExprPtr expr
		, bool enabled )
	...
	ReturnWrapperT< ValueT > Vec4T< ValueT >::operator[]( IndexT const & offset )const
	{
		return writeBinOperator< ValueT >( *this, offset, sdw::makeArrayAccess );
	}

	template< typename ValueT >
	ReturnWrapperT< ValueT > Vec4T< ValueT >::operator[]( int32_t offset )const
	{
		return writeBinOperator< ValueT >( *this, offset, sdw::makeArrayAccess );
	}

	template< typename ValueT >
	ReturnWrapperT< ValueT > Vec4T< ValueT >::operator[]( uint32_t offset )const
	{
		return writeBinOperator< ValueT >( *this, offset, sdw::makeArrayAccess );
	}

	template< typename ValueT >
	ReturnWrapperT< Vec4T< ValueT > > Vec4T< ValueT >::operator+=( Vec4T< ValueT > const & rhs )
	{
		return writeAssignOperator< Vec4T< ValueT > >( *this, rhs, sdw::makeAddAssign );
	}

	template< typename ValueT >
	ReturnWrapperT< Vec4T< ValueT > > Vec4T< ValueT >::operator-=( Vec4T< ValueT > const & rhs )
	{
		return writeAssignOperator< Vec4T< ValueT > >( *this, rhs, sdw::makeMinusAssign );
	}

	template< typename ValueT >
	ReturnWrapperT< Vec4T< ValueT > > Vec4T< ValueT >::operator*=( Vec4T< ValueT > const & rhs )
	{
		return writeAssignOperator< Vec4T< ValueT > >( *this, rhs, sdw::makeTimesAssign );
	}

	template< typename ValueT >
	ReturnWrapperT< Vec4T< ValueT > > Vec4T< ValueT >::operator/=( Vec4T< ValueT > const & rhs )
	{
		return writeAssignOperator< Vec4T< ValueT > >( *this, rhs, sdw::makeDivideAssign );
	}

	template< typename ValueT >
	ReturnWrapperT< Vec4T< ValueT > > Vec4T< ValueT >::operator+=( ValueT const & rhs )
	{
		return writeAssignOperator< Vec4T< ValueT > >( *this, rhs, sdw::makeAddAssign );
	}
	...
	template< typename ValueT >
	ReturnWrapperT< Vec4T< ValueT > > Vec4T< ValueT >::operator-()const
	{
	...
	template< typename ValueT >
	ast::type::TypePtr Vec4T< ValueT >::makeType( ast::type::TypesCache & cache )
	{
	...
	template< typename ValueT >
	ReturnWrapperT< Vec4T< Boolean > > operator==( Vec4T< ValueT > const & lhs, Vec4T< ValueT > const & rhs )
	{
	...
	ReturnWrapperT< Vec4T< ValueT > > operator+( LhsT const & lhs
