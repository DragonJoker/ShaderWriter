...
namespace ast::expr
{
	...
	public:
		...
		SDAST_API LiteralPtr makeLiteral( type::TypesCache & typesCache, int8_t value );
		SDAST_API LiteralPtr makeLiteral( type::TypesCache & typesCache, int16_t value );
		SDAST_API LiteralPtr makeLiteral( type::TypesCache & typesCache, int32_t value );
		SDAST_API LiteralPtr makeLiteral( type::TypesCache & typesCache, int64_t value );
		SDAST_API LiteralPtr makeLiteral( type::TypesCache & typesCache, uint8_t value );
		SDAST_API LiteralPtr makeLiteral( type::TypesCache & typesCache, uint16_t value );
		SDAST_API LiteralPtr makeLiteral( type::TypesCache & typesCache, uint32_t value );
		SDAST_API LiteralPtr makeLiteral( type::TypesCache & typesCache, uint64_t value );
